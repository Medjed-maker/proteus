...
logger: logging.Logger = logging.getLogger("phonology.languages.ancient_greek.lsj_extractor")


def _lexicon_data_dir() -> Path:
    """Return the language-scoped lexicon data directory."""
    return resolve_language_data_dir("ancient_greek", "lexicon")
...
def validate_document(
    ...
    if schema_path is None:
        schema_path = _lexicon_data_dir() / "greek_lemmas.schema.json"
