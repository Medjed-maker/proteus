...
def extract_entry(entry_elem: Any) -> dict[str, Any] | None:
    ...
    Side effects:
        ...
        ``phonology.languages.ancient_greek.lsj_extractor`` at call time so shim monkeypatches apply.
    ...
    Raises:
        ...
        Known IPA conversion failures (``ValueError``) are caught and return
        ``None``; other conversion errors propagate.
    """
