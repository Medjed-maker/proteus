...
MATRIX_PATH = resolve_language_data_dir("ancient_greek", "matrices") / "attic_doric.json"
...
def _normalize_generated_at(generated_at: str | None) -> str:
    ...
    # generated_at values ending in "Z" are made explicit UTC offsets;
    # values already carrying an offset are left unchanged.
    normalized = (
