...
class TestSearchPartial:
    ...
    def test_partial_query_preselection_retains_zero_overlap_tail_within_window(
        ...
        assert (
            ...
            == search_module._MIN_PARTIAL_STAGE2_CANDIDATES
        )
        expected_candidate_ids = ["L1", "L2"] + [
            f"L{index:03d}"
            for index in range(3, search_module._MIN_PARTIAL_STAGE2_CANDIDATES + 1)
        ]
    ...
    def test_partial_query_preselection_caps_exact_matches_to_stage2_window(
        ...
        assert (
            ...
            == exact_ids[: search_module._MIN_PARTIAL_STAGE2_CANDIDATES]
        )
    ...
    def test_partial_suffix_query_prefers_suffix_match_over_higher_confidence_noise(
        ...
        lexicon = [
            ...
            {
                "id": "L2",
                "headword": "high-confidence-noise",
                "ipa": "b a x",
                "dialect": "attic",
            },
            {
                "id": "L3",
                "headword": "partial-suffix",
                "ipa": "x c",
                "dialect": "attic",
            },
        ]
    ...
    def test_partial_query_prefers_rule_supported_overlap_over_higher_confidence_overlap(
        ...
        lexicon = [
            ...
            {
                "id": "L2",
                "headword": "high-confidence-overlap",
                "ipa": "p u",
                "dialect": "attic",
            },
        ]
    ...
    def test_partial_query_prefers_stronger_fragment_match_over_rule_supported_noise(
        ...
        lexicon = [
            {
                "id": "L1",
                "headword": "rule-supported-weak-overlap",
                "ipa": "p i",
                "dialect": "attic",
            },
            {
                "id": "L2",
                "headword": "full-prefix-match",
                "ipa": "p a",
                "dialect": "attic",
            },
        ]
    ...
    def test_partial_infix_query_supports_zero_length_gap_and_rejects_wrong_order(
        ...
        monkeypatch.setattr(
            search_module,
            "to_ipa",
            lambda query, dialect="attic": {"ac": "a c", "a": "a", "c": "c"}.get(
                query, query
            ),
        )
        monkeypatch.setattr(
        ...
        assert [result.lemma for result in results] == [
            "zero-gap",
            "with-gap",
            "right-only-fragment",
        ]
